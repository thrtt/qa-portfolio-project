# Inventory Test Scenarios - SauceDemo

## Product Inventory

| ID | Test Scenario | Priority |
|---|---|---|
| IS-001 | Verify products are displayed on the inventory page | High |
| IS-002 | Verify product details are displayed correctly | Medium |
| IS-003 | Verify user can add a product to the cart | High |
| IS-004 | Verify user can remove a product from the inventory page | High |
